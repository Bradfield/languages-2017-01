const fs = require('fs');
testFiles = fs.readdirSync('./examples');
...
testFiles.forEach(function(file) {
    const test = require('./examples' + '/' + file);
    const ast = parser.parse(test.testCase, factory);
    console.log(deepCompare(ast, test.expectedOutput));
});
